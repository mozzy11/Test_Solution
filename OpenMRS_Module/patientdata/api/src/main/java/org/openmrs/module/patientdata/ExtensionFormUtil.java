...
public class ExtensionFormUtil {
	...
	public static ExtensionForm getExtensionFormFromUiResourceAndForm(ResourceFactory resourceFactory, String providerName,
	        String formPath, FormEntryAppService hfeAppService, FormManager formManager, Form form) throws Exception {
	...
	protected static ExtensionForm getExtensionFormFromXML(String formXml) throws Exception {
		...
		boolean doProcess = processFlag.equalsIgnoreCase("yes") || processFlag.equalsIgnoreCase("true")
		        || processFlag.equalsIgnoreCase("1");
